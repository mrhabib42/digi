    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-dark py-2 collapse-inner rounded">
                <h6 class="collapse-header text-white">Attendance:</h6>
                <a class="collapse-item ci text-white" href="#">Daily Attendance</a>
                <a class="collapse-item ci text-white" href="#">Monthly Attendance</a>
                <a class="collapse-item ci text-white" href="#">Yearly Attendance</a>
            </div>
        </div>
    </li>
